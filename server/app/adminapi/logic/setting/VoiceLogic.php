...
//            $config['speed'] = VoiceEnum::KDXF == $key ? (int)$config['speed'] : (float)$config['speed'];
            if(VoiceEnum::KDXF == $key){
                //兼容旧数据
                $config['pronounce_list'] = $defaultConfig['pronounce_list'];
                if(!in_array($config['pronounce'],array_keys($config['pronounce_list']))){
                    $config['pronounce'] = $defaultConfig['pronounce'];
                }
