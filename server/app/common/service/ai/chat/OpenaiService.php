...
class OpenaiService
{
    ...
    public function chatHttpRequest(array $messages): array
    {
        ...
        // 处理混元模型报错
        if (str_contains(trim($this->baseUrl), 'https://api.hunyuan.cloud.tencent.com')) {
    ...
    public function chatSseRequest(array $messages): self
    {
        ...
        // 处理混元模型报错
        if (str_contains($this->baseUrl, 'https://api.hunyuan.cloud.tencent.com')) {
            unset($data['presence_penalty']);
        }
    ...
    public function getUsage(): array
    {
        ...
        if (!$this->usage or empty($this->usage)) {
